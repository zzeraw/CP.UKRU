...
INSERT INTO `banners` (`id`, `title`, `link`, `image`, `image_attr_title`, `image_attr_alt`, `body`, `nn`, `created_ip`, `created_datetime`, `created_user`, `modified_username`, `created_username`, `modified_ip`, `modified_datetime`, `modified_user`, `active`)
VALUES
...
VALUES
	(1,'header','Шапка','<div class=\"header\">\r\n<div class=\"container\">\r\n<div class=\"left-side\"><br />&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a style=\"font-size: 38px;\" class=\"font-h\" href=\"/blog/\">Мой блог</a></div>\r\n<div class=\"logo\"><a href=\"/\"><img src=\"/uploads/logo.png\" alt=\"\" /></a></div>\r\n<div class=\"right-side\"><br /><a style=\"font-size: 38px;\" class=\"font-h\" href=\"/portfolio/\">Мои работы</a>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</div>\r\n<div class=\"clearfix\"></div>\r\n</div>\r\n</div>','127.0.0.1 Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.71 Safari/537.36','2014-12-03 14:49:14',1,'zzeraw','::1 Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36','2015-01-29 19:06:08',2,'manager',1),
...
INSERT INTO `blog_post_tags` (`post_id`, `tagId`)
VALUES
	(3,6),
	(3,7),
	(3,8);
...
INSERT INTO `blog_posts` (`id`, `title`, `annotation`, `body`, `meta_index`, `meta_title`, `meta_keywords`, `meta_description`, `created_ip`, `created_datetime`, `created_user`, `created_username`, `modified_ip`, `modified_datetime`, `modified_user`, `modified_username`, `active`)
VALUES
...
INSERT INTO `blog_tags` (`id`, `name`, `count`)
VALUES
	(1,'тег1',0),
	(2,'тег2',0),
	(3,'тег3',0),
...
INSERT INTO `form_requests` (`id`, `fio`, `phone`, `email`, `description`, `created_ip`, `created_datetime`)
VALUES
...
# Дамп таблицы portfolio_item_tags
# ------------------------------------------------------------
...
LOCK TABLES `portfolio_item_tags` WRITE;
/*!40000 ALTER TABLE `portfolio_item_tags` DISABLE KEYS */;

INSERT INTO `portfolio_item_tags` (`post_id`, `tagId`)
VALUES
	(25,1),
	(44,1),
	(52,1),
...
INSERT INTO `portfolio_items` (`id`, `title`, `annotation`, `body`, `image`, `image_attr_title`, `image_attr_alt`, `nn`, `meta_index`, `meta_title`, `meta_description`, `meta_keywords`, `created_ip`, `created_datetime`, `created_user`, `created_username`, `modified_ip`, `modified_datetime`, `modified_user`, `modified_username`, `active`)
VALUES
...
INSERT INTO `portfolio_tags` (`id`, `name`, `count`)
VALUES
	(1,'Макаронс',3),
	(2,'печенье',3),
	(3,'торт',24),
...
INSERT INTO `users` (`id`, `username`, `password`, `role`, `description`, `created_ip`, `created_datetime`, `created_user`, `created_username`, `modified_ip`, `modified_datetime`, `modified_user`, `modified_username`, `active`)
VALUES
